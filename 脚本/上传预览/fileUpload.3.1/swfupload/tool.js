...
function fileUpload(config){
    ...
    if(!Boolean(window.FormData) || (browsers.msie && parseInt(browsers.version)<10)){
        swfUp({
            ...
            'post_params':{field:element.attr('data-field')},
            'text':'上传文件',
        ...
        function uploadImage(obj) {
            if(validateImage(obj)) {
                ...
                data.append('field', element.attr('data-field'));
...
//            file_queue_error_handler: fileQueueError,
            ...
            upload_error_handler : errorFn,//错误处理事件
