...
12===c._a[3]&&(c._a[3]=0);L(c)}function F(c,a,b,d,e){return e.relativeTime(a||1,!!b,c,d)}function E(c,a,b){a=b-a;b-=c.day();b>a&&(b-=7);b<a-7&&(b+=7);c=h(c).add("d",b);return{week:Math.ceil(c.dayOfYear()/7),year:c.year()}}function P(c){var b=c._i,d=c._f;if(null===b||""===b)return null;"string"===typeof b&&(c._i=b=q().preparse(b));if(h.isMoment(b))c=k({},b),c._d=new Date(+b._d);else if(d)if("[object Array]"===Object.prototype.toString.call(d)){var b=c,e,g,l=99,m;for(m=0;m<b._f.length;m++)e=k({},b),
    ...
    typeof b?b:"millisecond";return+this.clone().startOf(b)>+h(a).startOf(b)},isBefore:function(a,b){b="undefined"!==typeof b?b:"millisecond";return+this.clone().startOf(b)<+h(a).startOf(b)},isSame:function(a,b){b="undefined"!==typeof b?b:"millisecond";return+this.clone().startOf(b)===+h(a).startOf(b)},min:function(a){a=h.apply(null,arguments);return a<this?this:a},max:function(a){a=h.apply(null,arguments);return a>this?this:a},zone:function(a){var b=this._offset||0;if(null!=a)"string"===typeof a&&(a=
        C(a)),16>Math.abs(a)&&(a*=60),this._offset=a,this._isUTC=!0,b!==a&&r(this,h.duration(b-a,"m"),1,!0);else return this._isUTC?b:this._d.getTimezoneOffset();return this},zoneAbbr:function(){return this._isUTC?"UTC":""},zoneName:function(){return this._isUTC?"Coordinated Universal Time":""},daysInMonth:function(){return h.utc([this.year(),this.month()+1,0]).date()},dayOfYear:function(a){var b=y((h(this).startOf("day")-h(this).startOf("year"))/864E5)+1;return null==a?b:this.add("d",a-b)},weekYear:function(a){var b=
        E(this,this.lang()._week.dow,this.lang()._week.doy).year;return null==a?b:this.add("y",a-b)},isoWeekYear:function(a){var b=E(this,1,4).year;return null==a?b:this.add("y",a-b)},week:function(a){var b=this.lang().week(this);return null==a?b:this.add("d",7*(a-b))},isoWeek:function(a){var b=E(this,1,4).week;return null==a?b:this.add("d",7*(a-b))},weekday:function(a){var b=(this._d.getDay()+7-this.lang()._week.dow)%7;return null==a?b:this.add("d",a-b)},isoWeekday:function(a){return null==a?this.day()||
    7:this.day(this.day()%7?a:a-7)},lang:function(b){if(b===a)return this._lang;this._lang=q(b);return this}};for(t=0;t<J.length;t++)R(J[t].toLowerCase().replace(/s$/,""),J[t]);R("year","FullYear");h.fn.days=h.fn.day;h.fn.months=h.fn.month;h.fn.weeks=h.fn.week;h.fn.isoWeeks=h.fn.isoWeek;h.fn.toJSON=h.fn.toISOString;h.duration.fn=g.prototype={_bubble:function(){var a=this._milliseconds,b=this._days,d=this._months,e=this._data;e.milliseconds=a%1E3;a=l(a/1E3);e.seconds=a%60;a=l(a/60);e.minutes=a%60;a=l(a/
    60);e.hours=a%24;b+=l(a/24);e.days=b%30;d+=l(b/30);e.months=d%12;b=l(d/12);e.years=b},weeks:function(){return l(this.days()/7)},valueOf:function(){return this._milliseconds+864E5*this._days+this._months%12*2592E6+31536E6*~~(this._months/12)},humanize:function(a){var b=+this,d;d=!a;var e=this.lang(),f=y(Math.abs(b)/1E3),g=y(f/60),h=y(g/60),k=y(h/24),l=y(k/365),f=45>f&&["s",f]||1===g&&["m"]||45>g&&["mm",g]||1===h&&["h"]||22>h&&["hh",h]||1===k&&["d"]||25>=k&&["dd",k]||45>=k&&["M"]||345>k&&["MM",y(k/
        30)]||1===l&&["y"]||["yy",l];f[2]=d;f[3]=0<b;f[4]=e;d=F.apply({},f);a&&(d=this.lang().pastFuture(b,d));return this.lang().postformat(d)},add:function(a,b){var d=h.duration(a,b);this._milliseconds+=d._milliseconds;this._days+=d._days;this._months+=d._months;this._bubble();return this},subtract:function(a,b){var d=h.duration(a,b);this._milliseconds-=d._milliseconds;this._days-=d._days;this._months-=d._months;this._bubble();return this},get:function(a){a=m(a);return this[a.toLowerCase()+"s"]()},as:function(a){a=
    m(a);return this["as"+a.charAt(0).toUpperCase()+a.slice(1)+"s"]()},lang:h.fn.lang};for(t in K)K.hasOwnProperty(t)&&(S(t,K[t]),ha(t.toLowerCase()));S("Weeks",6048E5);h.duration.fn.asMonths=function(){return(+this-31536E6*this.years())/2592E6+12*this.years()};h.lang("en",{ordinal:function(a){var b=a%10;return a+(1===~~(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th")}});M&&(module.exports=h);"undefined"===typeof ender&&(this.moment=h);"function"===typeof define&&define.amd&&define("moment",[],
    function(){return h});this.moment=h}).call("undefined"===typeof r?window:r);if(!r.moment)if(window.moment)r.moment=window.moment;else throw"Kalendae requires moment.js. You must use kalendae.standalone.js if moment is not available on the page.";l=r.moment;l.fn.yearDay=function(a){var b=Math.floor(this._d/864E5);return"undefined"===typeof a?b:this.add({d:a-b})};w=r.moment().startOf("day");"undefined"===typeof jQuery||"function"!==typeof document.addEventListener&&!d.isIE8()||(jQuery.fn.kalendae=function(a){this.each(function(b,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       d){"INPUT"===d.tagName?$(d).data("kalendae",new r.Input(d,a)):$(d).data("kalendae",new r($.extend({},{attachTo:d},a)))});return this})})();